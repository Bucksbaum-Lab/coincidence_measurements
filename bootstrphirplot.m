function bootstrphirplot(parallel, perpendicular, nbins)

boot = bootstrp(1000,@(parallel,perpendicular) getcentroidbyhir(parallel,perpendicular),parallel,perpendicular);
